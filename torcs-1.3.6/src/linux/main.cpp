...
volatile double* pposX_ghost = NULL;
volatile double* pposY_ghost = NULL;
volatile double* pposZ_ghost = NULL;
...
//////////////////////////////////////////// end by Yurong
    ...
    // printf("********** TORCS: Set memory sharing key to %d successfully **********\n", key);
...
//////////////////////////////////////////// by Chenyi
    ...
    // printf("********** TORCS: Memory sharing started, attached at %X **********\n", shm);
...
//////////////////////////////////////////// by Yurong
    ...
    pposX_ghost = &shared->posX;
    pposY_ghost = &shared->posY;
    pposZ_ghost = &shared->posZ;
